        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed">
              Your trusted partner for unforgettable journeys and extraordinary
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                ...
                />
                <button className="bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-2 rounded-r-lg font-medium hover:from-blue-600 hover:to-blue-700 transition-all">
                  →
                </button>
              </div>
            </div>
